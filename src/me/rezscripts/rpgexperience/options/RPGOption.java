...
public enum RPGOption {
    ...
    RPGBOT_TIPS("Cecilla's Tips", true, "Receive tips from Rensa the chatbot every few minutes.", "Hide automatic tips from Cecilla."),
    ...
    RPGOption(String display, boolean def, String t, String f) {
    ...
    public static RPGOption get(String s) {
