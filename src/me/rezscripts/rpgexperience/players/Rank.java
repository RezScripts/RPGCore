...
public enum Rank {
    ...
    CONTENT_MANAGER(8, "Manager", "Content-Manager", ChatColor.AQUA, ChatColor.WHITE),
    MOD(9, "Mod", "Moderator", ChatColor.LIGHT_PURPLE, ChatColor.WHITE),
    ADMIN(10, "Admin", "Administrator", ChatColor.GREEN, ChatColor.WHITE),
    HEAD_ADMIN(10, "Head-Admin", "Head-Administrator", ChatColor.DARK_GREEN, ChatColor.WHITE),
    OWNER(11, "Owner", "Owner", ChatColor.YELLOW, ChatColor.WHITE),
    DEV(12, "Dev", "Developer", ChatColor.DARK_PURPLE, ChatColor.WHITE),
    LEAD_DEV(12, "Lead-Dev", "Lead-Developer", ChatColor.DARK_PURPLE, ChatColor.WHITE);
