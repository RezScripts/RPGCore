...
public class RMath {
    ...
    public static double round2(final double value, final int precision) {
    ...
    public static int  calculatePercent(int value, float percentage)
    {
        return (int)(value*(percentage/100.0f));
    }

    public static float calculatePercentOfNumber(float n, float total)
    {
        Bukkit.getConsoleSender().sendMessage(n + ":" + total);
